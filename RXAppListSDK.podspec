...
Pod::Spec.new do |s|
  s.name             = 'RXAppListSDK'
  s.version          = '3.8.0'
  s.summary          = 'ruixue RXAppListSDK framework.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ruixueyun/RXAppListSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  #s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ruixue' => 'xingdonghai@weile.com' }
  s.source           = { :git => 'https://github.com/ruixueyun/RXAppListSDK.git', :tag => s.version.to_s }
